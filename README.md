...
2. **Biallelic sites only** — multiallelic sites should be split or removed before running. The script will warn you if it detects any.
...
- Zhao, K., Lensink, M., & Monroe, J. G. (2026). Functional insights into dispensable genes using genome-wide loss-of-function burden tests in Arabidopsis. *The Plant Cell*, koag087. https://doi.org/10.1093/plcell/koag087

Please also cite the tools it depends on:
